...
class MeetNowDoctorVC: UIViewController,UITableViewDelegate,UITableViewDataSource {
    
    @IBOutlet weak var meetNowDoctor_tableView: UITableView!
    ...
    @IBOutlet weak var meetNow_Button: UIButton!
    @IBOutlet weak var meetNowButton_view: UIView!
    ...
    func setupOnLoad()
    {
        ...
        meetNowDoctor_tableView.backgroundColor = .white
        ...
        meetNowDoctor_tableView.estimatedRowHeight = 130.0
        meetNowDoctor_tableView.rowHeight = UITableView.automaticDimension
    }
    ...
    @IBAction func meetNowButton_Action(_ sender: Any)
    {
        let vc = storyboard?.instantiateViewController(withIdentifier: "AddPaymentDetailsVC") as! AddPaymentDetailsVC
        vc.meetWaitingSchedule_value = "1"
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier: "MeetNowDoctorTVcell") as! MeetNowDoctorTVcell
