...
struct Colors {
    ...
    static var darkRed = #colorLiteral(red: 0.9686274529, green: 0.78039217, blue: 0.3450980484, alpha: 1)
}
...
class CalenderView: UIView, UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout, MonthViewDelegate {
    ...
    func collectionView(_ collectionView: UICollectionView, didSelectItemAt indexPath: IndexPath)
    {
        ...
        if  bookedSlotDate.contains(calcDate)
        {
            ...
            lbl.textColor=UIColor.black //red
            ...
            delegate?.didTapDate(date: "Date:\(calcDate)/\(currentMonthIndex)", available: true)
